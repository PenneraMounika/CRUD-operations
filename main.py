...
cur=conn.cursor()
cur.execute("""CREATE TABLE IF NOT EXISTS student(id int,name varchar(250),dob date);""")
cur.execute("""CREATE TABLE IF NOT EXISTS teacher(employee_id int,name varchar(250),age int,doj date);""")
